...
class AppColors {
  ...
  static const Color background = Color(0xFF121212); // أقل حدة من الأسود الكامل
  static const Color surface = Color(0xFF1E1E1E); // كروت المقالات / Panels
  static const Color overlay = Color(0xFF1A2933); // Elevated surfaces / Footer
  ...
  static const Color textSecondary = Color(0xFFC0C4CC);
