...
class GetAiSummaryUseCase {
  ...
  Future<String> call({
    ...
    const systemPrompt =
        'أنت خبير في تلخيص الأخبار. مهمتك هي قراءة قائمة من عناوين الأخبار ووصفها، ثم تقديم ملخص من فقرة واحدة (باللغة العربية) لأهم النقاط والأحداث المتعلقة بالموضوع الرئيسي للبحث.';
    ...
    final userQuery =
        ...
        '\n\nالرجاء تقديم ملخص (باللغة العربية) لهذه النتائج.';
