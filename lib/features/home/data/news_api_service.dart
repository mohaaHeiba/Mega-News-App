...
class NewsApiService implements NewsDataSource {
  static const String _baseUrl = 'https://newsapi.org/v2';

  @override
  Future<List<Article>> fetchTopHeadlines({String category = 'general'}) async {
    final apiKey = '32a4184658214dd8aeffec62c2ac5717';
    if (apiKey.isEmpty) return <Article>[];

    final url = Uri.parse(
      '$_baseUrl/top-headlines?country=us&category=$category&apiKey=$apiKey',
    );
